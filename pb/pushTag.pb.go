...
func (x *TagPushRequest) GetTag() *Tag {
	if x != nil {
		return x.Tag
	}
	return nil
...
func (x *TagPushRequest) GetSign() []byte {
	if x != nil {
		return x.Sign
	}
	return nil
...
var file_pushTag_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x73, 0x74, 0x22, 0x3c, 0x0a, 0x0e, 0x54, 0x61, 0x67, 0x50, 0x75, 0x73, 0x68, 0x52,
	...
	0x67, 0x6e, 0x22, 0x25, 0x0a, 0x0f, 0x54, 0x61, 0x67, 0x50, 0x75, 0x73, 0x68, 0x52, 0x65, 0x73,
...
var file_pushTag_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pushTag_proto_goTypes = []interface{}{
	(*T)(nil),               // 0: T
	(*Tag)(nil),             // 1: Tag
	(*TagPushRequest)(nil),  // 2: TagPushRequest
	(*TagPushResponse)(nil), // 3: TagPushResponse
}
var file_pushTag_proto_depIdxs = []int32{
	0, // 0: Tag.t:type_name -> T
	1, // 1: TagPushRequest.tag:type_name -> Tag
